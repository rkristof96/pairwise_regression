...
diff_matrix = zeros(length(sigma_list)*2,4);
...
% mean
diff_matrix(sigma_ind*2-1,1) = mean(diff_alpha(sigma_ind,:));
diff_matrix(sigma_ind*2-1,2) = mean(diff_alpha2(sigma_ind,:));
diff_matrix(sigma_ind*2-1,3) = mean(diff_beta(sigma_ind,:));
diff_matrix(sigma_ind*2-1,4) = mean(diff_beta2(sigma_ind,:));
%std
diff_matrix(sigma_ind*2,1) = std(diff_alpha(sigma_ind,:));
diff_matrix(sigma_ind*2,2) = std(diff_alpha2(sigma_ind,:));
diff_matrix(sigma_ind*2,3) = std(diff_beta(sigma_ind,:));
diff_matrix(sigma_ind*2,4) = std(diff_beta2(sigma_ind,:));
